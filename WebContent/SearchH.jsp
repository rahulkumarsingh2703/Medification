  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        ...
        <li class="active" id="firstLink"><a href="SearchH.jsp" class="scroll-link">Hospital List</a></li>
...
<div class="container" >
<iframe src="Search/SearchHospital.jsp" frameborder="0" style="overflow: scroll;"></iframe>>
</div>
</div>
</div>
</body>
