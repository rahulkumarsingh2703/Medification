...
<meta charset="utf-8">
<meta name="google-signin-client_id" content="989851382201-gtbm6eff5t1kmod9leueqd2ng82k1tgt.apps.googleusercontent.com">
...
<section id="services" class="page-section colord">
  <div class="container">
    <div class="row"> 
      <!-- item -->
      <div class="col-md-3 text-center"> <a href=""><i class="circle"><img src="images/hospital.png" alt="" /></i></a>
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><a href=""><i class="circle"> <img src="images/eye.png" alt="" /></i></a>
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><a href=""><i class="circle"> <img src="images/symp.png" alt="" /></i></a>
      ...
      <!-- item -->
      <div class="col-md-3 text-center"><a href=""><i class="circle"> <img src="images/heart.png" alt="" /></i></a>
...
<div class="container">
        <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center"> Copyright 2016 | All Rights Reserved -- Designed & Developed by <a href="#"> Executioners</a> </div>
    </div>
    <!-- / .row --> 
  </div>
...
<script>
  function signOut() {
    ...
    auth2.signOut().then(function () {
      ...
      window.location.assign("http://localhost:8088/Medification/SearchHospital.jsp");
    });
  }
</script>
