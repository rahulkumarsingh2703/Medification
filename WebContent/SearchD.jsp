  ...
  <div class="container">
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        ...
        <li class="active" id="firstLink"><a href="SearchD.jsp" class="scroll-link">Doctor Database</a></li>
...
<div class="container" >
<iframe src="Search/SearchDoctor.jsp" frameborder="0" style="overflow: scroll;"></iframe>
</div>
</div>
</div>
</body>
