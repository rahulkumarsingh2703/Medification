...
public class CombineModels {
	public static void main(String[] args) throws Exception {
		//load dataset
		String data = "/Project-Medification/DataBase/heart/bagging/trainafilterheart.arff";
		...
		DataSource src1 = new DataSource("/Project-Medification/DataBase/heart/bagging/testafilterheart.arff");
		...
		DataSource src11 = new DataSource("/Project-Medification/DataBase/heart/bagging/testafilterheart.arff");
		...
		DataSource src111 = new DataSource("/Project-Medification/DataBase/heart/bagging/testafilterheart.arff");
