...
public class BaggingModelh {
	...
	public void Mining() throws Exception
	{
				...
				weka.core.SerializationHelper.write("/Project-Medification/DataBase/heart/bagging/hmodel.model", bg);
	}

	public static void main(String args[]) throws Exception{
		
		BaggingModelh ob=new BaggingModelh();
		ob.Mining();
